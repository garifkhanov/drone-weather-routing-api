...
Проект создан как учебный backend-сервис на FastAPI. Он демонстрирует работу с пользователями, JWT-авторизацией, реляционной базой данных, CRUD-операциями и алгоритмической логикой поиска маршрута с учётом погодного риска.
...
Проект подходит для учебной защиты, демонстрации backend-разработки на FastAPI и объяснения алгоритма поиска пути по графу.
